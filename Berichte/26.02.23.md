...
1. search ftp scanner
2. use auxiliary/scanner/ftp/ftp_version
3. options
4. set RHOSTS 192.168.13.51
5. set RPORT 21
6. run

```
msf6 auxiliary(scanner/ftp/ftp_version) > run
[+] 192.168.13.51:21      - FTP Banner: '220 (vsFTPd 2.3.4)\x0d\x0a'
[*] 192.168.13.51:21      - Scanned 1 of 1 hosts (100% complete)
[*] Auxiliary module execution completed
```
FTP Banner: '220 (**vsFTPd 2.3.4**)\x0d\x0a'  
vsFTPd 2.3.4 => ist die Installierte Version die auch zur  Schwachstelle von CVE-2011-2523 gehört(vorherige Übung) 

# Übung (msf vsftpd exploit)

1. Beide VM-Wares auf NAT stellen
2. search vsftpd
...
[-] 192.168.13.51:21 - Exploit failed [unreachable]: Rex::ConnectionTimeout The connection with (192.168.13.51:21) timed out.
